...
public class CommonConstant {
     ...
     * 云曜默认AppId
     */
	public static final String LDAP_DEFAULT_YUN_YAO_APPID = "HikYun";
    /**
     * 海康云默认AppId
     */
	public static final String LDAP_DEFAULT_HIK_CLOUD_APPID = "HikCloud";
	/**
	 * 运营管理员用户角色
	 */
	 ...
	 * 海康云系统标识
	 */
	public static final String HIK_CLOUD_CONVENT_USER = "HikCloud";
	
	/**
	 * 海康云曜系统标识
	 */
	public static final String HIK_YUN_CONVENT_USER = "HikYun";
	/**
	 * 系统管理员的uniqueID
	 */
